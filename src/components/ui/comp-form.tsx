...
import { createComp, getCompetitionLogo, saveCompetitionLogo } from "@/utils/jsonUtils"
...
const uploadButton = (
    <button style={{ border: 0, background: 'none' }} className="flex items-center flex-col" type="button">
        <Plus />
