...
const ScoreGenerate = () => {
    ...
    }, [competitionContext.contestants, competitionContext.compInfo.platformConfig, event])
    ...
    useEffect(() => {
        updateInstance(<TimelineDocument
            ...
            event={event}
            castCount={castCount} />);
    }, [updateInstance, distanceData, competitionContext.compInfo.platformConfig, event, castCount]);
...
function TimelineDocument({ data, platfromCount, event, castCount }: DocumentProps) {
