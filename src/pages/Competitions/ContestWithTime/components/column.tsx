...
export const getColumns = (
    ...
    return [
        ...
        { ...Cols.Actions.SingleScore_Score({ tableApi, contestId, multipleOf }), getApplyQuickFilterFn: () => null },
        { ...Cols.Actions.SingleScore_Time({ tableApi, contestId }), getApplyQuickFilterFn: () => null },
        Cols.Actions.Akcje({
            tableApi,
            actions: {
                Edit: true,
