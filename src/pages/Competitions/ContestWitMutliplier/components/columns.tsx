...
export const getColumns = (
    ...
    return [
        ...
        { ...Cols.Actions.ScoreWithMultiplier_Score({ tableApi, contestId }), getApplyQuickFilterFn: () => null },
        { ...Cols.Actions.ScoreWithMultiplier_MultipliedScore({ tableApi, contestId }), getApplyQuickFilterFn: () => null },
        Cols.Actions.Akcje({
            tableApi,
            actions: {
                Edit: true,
